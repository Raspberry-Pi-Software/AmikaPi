...
if not sys.platform.startswith('linux'):
    ...
    log(f"Running on a Linux system or supported distribution. You are on {Fore.GREEN}{sys.platform.partition('linux')[1]}{Fore.RESET} bit.", parent=parents.SIGNAL, time=False)
